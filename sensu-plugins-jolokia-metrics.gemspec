...
require 'date'
require 'sensu-plugins-jolokia-metrics'
...
Gem::Specification.new do |s| # rubocop:disable Metrics/BlockLength
  ...
  s.homepage               = 'https://github.com/fgouteroux/sensu-plugins-jolokia-metrics'
  s.license                = 'MIT'
  ...
  s.name                   = 'sensu-plugins-jolokia-metrics'
  ...
  s.version                = SensuPluginsJolokiaMetrics::Version::VER_STRING
